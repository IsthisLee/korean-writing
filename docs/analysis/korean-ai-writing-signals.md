...
아래는 2026-09-15 대화에서 사용자가 정했습니다. 앞의 여덟 줄은 계획 초안 전에, 뒤의 네 줄(개인 블로그, 교정 도구 범위, 「가를 수 없다」 처리, 비용 승인)은 초안을 쓴 뒤에 정했습니다. 「후보 패턴을 만드는 근거」 줄은 2026-09-16 에 더했습니다. 표 끝의 「결과 문서」 앞 여섯 줄은 1차 파일럿 결과를 보고 2026-09-16 에 정했습니다.
...
2. **「사람 글 0건」 문턱은 30편으로 정할 수 없었습니다.** 1차 사람 글 최댓값을 문턱으로 삼자 새 사람 글의 6/30편이 넘었습니다. 4.4 에 따라 문턱 규칙을 사용자와 다시 정합니다.
