...
>
> **지금 상태 (2026-09-15):** 기준 공개와 연구 조사를 마쳤고 파일럿을 시작하기 전입니다. 도구 비교 결과는 아직 없습니다.
>
...
| 지금 어디까지 왔나 | 기준 공개와 연구 조사를 마침. 다음은 작은 규모의 파일럿 |
...
| 2. 파일럿 | 사람 글 30편과 AI 글 30편으로 수집부터 계산까지 한 번 돌립니다 | 큰 비용을 쓰기 전에 도구가 맞게 도는지, 쓸 만한 흔적이 남을 가망이 있는지 봅니다 | 다음 |
...
파일럿이 끝나면 이 문서에 결과 요약을 더합니다. 본 측정이 끝나면 어느 흔적이 믿을 만했는지, 어느 도구가 어떤 점에서 나았는지, 이 플러그인이 무엇을 채택했고 왜 그렇게 정했는지를 이 문서에 적습니다.
