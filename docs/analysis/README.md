...
>
> **지금 상태 (2026-09-16):** 1차·2차 파일럿을 마쳤습니다. 여러 흔적을 합친 점수가 새 표본에서도 사람 글과 AI 글을 갈라 본 측정을 준비하는 중이며, 도구 비교 결과는 아직 없습니다.
>
...
- [2. 분석으로 도출할 결론](#2-분석으로-도출할-결론)
- [3. 비교 분석 계획 (순서)](#3-비교-분석-계획-순서)
...
| 질문          | 답                                                                             |
| ----------- | ----------------------------------------------------------------------------- |
| 무엇을 정하려고 하나 | ① 믿을 만한 AI 티 목록과 그 심각도 ② 함께 켜 둘 한국어 output style ③ 이 플러그인에 넣을 윤문 도구 ④ 검사 훅에 남길 규칙           |
| 왜 하나        | 널리 퍼진 AI 티 목록은 대부분 연구 근거가 약하고, 사람 글을 AI 글로 잘못 잡거나 글을 고치다 뜻을 잃는 문제가 실제로 있었기 때문 |
| 어떻게 하나      | 누가 썼는지 확실한 사람 글 600편과 같은 주제의 Claude 글 1,200편에서 흔적을 세고, 뜻 손실과 AI 티로 도구를 비교     |
| 무엇이 기준인가    | 흔적은 사람 글에서 한 편도 나오지 않아야 채택. 도구는 뜻 손실 0건이 먼저, 그다음 AI 티, 그다음 명확성                |
| 지금 어디까지 왔나  | 1·2차 파일럿을 마침. 흔적 하나로는 가르지 못했지만 여러 흔적을 합친 점수는 새 표본에서도 갈라, 본 측정을 준비하는 중 |
...
| 검사 훅에 남길 규칙 | 저장할 때 알리는 K 규칙. 지금 규칙도 같은 기준으로 다시 판정 |
...
```mermaid
flowchart TD
  S0["0. 기준 잡기"] --> S1["1. 연구 조사<br>연구 근거가 있는 후보 43가지"]
  S1 --> S2["2. 파일럿<br>사람 글 30편 · AI 글 30편"]
  S2 -->|"도구가 제대로 돌고 가망이 있으면"| S3["3. 표본 수집<br>사람 글 600편 · AI 글 1,200편"]
  S2 -->|"가망이 없으면"| STOP["멈추고 다시 의논"]
  S3 --> S4["4. 흔적 분석<br>믿을 만한 AI 티와 심각도 · 검사 훅 규칙"]
...
| 2. 파일럿    | 사람 글 30편과 AI 글 30편으로 수집부터 계산까지 한 번 돌립니다                                    | 큰 비용을 쓰기 전에 도구가 맞게 도는지, 쓸 만한 흔적이 남을 가망이 있는지 봅니다                    | 1·2차 끝남(7절) |
| 3. 표본 수집  | 사람 글 600편과 같은 주제의 Claude 글 1,200편을 모읍니다                                 | 아래 「표본을 이렇게 모으는 이유」에 있습니다                                          | 대기     |
| 4. 흔적 분석  | 43가지 흔적을 두 묶음에서 세고 심각도를 계산하며, 검사 훅 규칙도 같은 표본으로 다시 정합니다                                              | 사람이 감으로 정하던 심각도를 숫자로 정하기 위해서입니다                                    | 대기     |
...
| 사람 글 600편                     | 절반은 흔적을 고르는 데, 절반은 확인하는 데 씁니다. 확인용 사람 글이 299편 이상이어야 「사람 글을 잘못 잡을 확률이 1% 이하」라고 95% 확신할 수 있습니다 |


### 판정 기준

- **믿을 만한 흔적:** 사람 글에서는 한 편도 나오지 않고, 그 흔적으로만 잡히는 AI 글이 한 편 이상일 것.
- **검사 훅 규칙:** 지금 K 규칙과 표본에서 뽑은 표현마다, 흔적을 고르는 쪽 사람 글에서 가장 많이 나온 횟수보다 1 많은 횟수를 문턱으로 삼습니다. 사람 글 600편이 한 편도 문턱을 넘지 않고 확인용 Claude 글이 한 편 이상 넘은 규칙만 남깁니다. 지금 규칙도 사람 글을 잡으면 뺍니다([분석 계획 5.7절](korean-ai-writing-signals.md#57-검사-훅-규칙-개편)).
...
**후보에서 뺀 것.** 널리 알려졌거나 이 플러그인의 검사 훅이 쓰는 표현이지만, 위 기준에 맞는 연구를 찾지 못했습니다. 뺐다고 해서 AI 티가 아니라는 뜻은 아니고, 연구 근거가 아직 없다는 뜻입니다. 검사 훅 규칙은 이 목록과 따로, 본 측정 표본에서 사람 글을 잡는지 직접 재서 남길지 정합니다(2절).
...
- **그래서 본 측정은 아직 시작하지 않았습니다.** 분석할 때 두 글의 길이를 맞추고, 번역 글이 많은 블로그를 표본에서 빼고, 여러 흔적을 합친 점수를 1차 파일럿으로 만들어 새 표본의 2차 파일럿으로 확인하기로 했습니다.

### 2차 파일럿 결과 (2026-09-16)

새 사람 글 30편과 Claude 글 30편으로 한 번 더 돌렸습니다. 이번에는 분석할 때 두 글의 길이를 맞췄고, 번역 글이 많은 블로그를 표본에서 뺐습니다. 수치는 [분석 계획 문서의 12절](korean-ai-writing-signals.md#12-2차-파일럿-결과)에 있습니다.

- **여러 흔적을 합친 점수는 새 표본에서도 사람 글과 AI 글을 갈랐습니다.** 1차 글로 만든 점수를 2차 글에 매기자, AI 글과 사람 글을 하나씩 짝지었을 때 AI 글의 점수가 더 높은 경우가 83%였습니다(AUROC 0.83). 사람 글과 AI 글의 표시를 무작위로 섞었을 때는 이런 값이 나오지 않았습니다.
- **파일럿 규모로는 「사람 글 0건」 문턱을 정할 수 없었습니다.** 1차 사람 글 30편의 최고점을 문턱으로 쓰자 새 사람 글 30편 가운데 6편이 문턱을 넘었고, 그중 3편이 개인 블로그 글이었습니다.
- **그래서 문턱은 본 측정에서 정합니다.** 확인용 사람 글 300편에서 한 편도 잡지 않는 문턱을 정하는 원래 계획을 그대로 따릅니다.
