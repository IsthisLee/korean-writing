...
>
> **지금 상태 (2026-09-16):** 1차 파일럿을 마쳤고, 판정 방식을 고쳐 2차 파일럿을 돌리는 중입니다. 도구 비교 결과는 아직 없습니다.
>
...
| 지금 어디까지 왔나 | 1차 파일럿을 마침. 흔적 하나로는 가르지 못해, 여러 흔적을 합친 점수로 2차 파일럿을 돌리는 중 |
...
| 2. 파일럿 | 사람 글 30편과 AI 글 30편으로 수집부터 계산까지 한 번 돌립니다 | 큰 비용을 쓰기 전에 도구가 맞게 도는지, 쓸 만한 흔적이 남을 가망이 있는지 봅니다 | 1차 끝남(7절), 2차 진행 중 |
