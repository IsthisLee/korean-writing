...
- **플러그인 사용자를 위한 비교 분석 안내를 더했습니다.** `docs/analysis/README.md` 에 무엇을 알아보는지, 사람 글과 AI 글을 어떻게 모으고 비교하는지, 지금까지 연구 조사로 알아낸 것과 그 근거 등급, 비교 대상, 한계를 쉬운 말로 정리했습니다. README 두 판의 「다른 도구와 무엇이 다른가」 절에서 링크합니다
