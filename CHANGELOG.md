...
- **검사 훅 규칙을 본 측정 표본으로 다시 정하는 기준을 결과보다 먼저 적었습니다.** 분석 계획 5.7절입니다. 지금 K 규칙과 선별용 표본에서 뽑은 표현마다 선별용 사람 글에 가장 많이 나온 횟수보다 1 많은 횟수를 문턱으로 삼고, 사람 글 600편이 한 편도 넘지 않고 검증용 Claude 글이 한 편 이상 넘은 규칙만 남깁니다. 지금 규칙도 사람 글을 잡으면 뺍니다. AI 신호 검사기는 저장소에만 두고 설치본에는 넣지 않기로 했습니다. README 와 비교 분석 안내에 같은 내용을 반영했습니다
- **플러그인 사용자를 위한 비교 분석 안내를 더했습니다.** `docs/analysis/README.md` 에 무엇을 알아보는지, 사람 글과 AI 글을 어떻게 모으고 비교하는지, 지금까지 연구 조사로 알아낸 것과 그 근거 등급, 비교 대상, 한계를 쉬운 말로 정리했습니다. README 두 판에서 링크합니다
- **한국어 AI 글 신호 분석 계획을 사전 등록 문서로 남겼습니다.** `docs/analysis/korean-ai-writing-signals.md` 에 표본 설계(위키·기술 블로그·개인 블로그 사람 글 750편 이상, 같은 주제의 Claude 글), 교정 도구 후보 전부 비교, 본 실행 전 파일럿, 심각도를 코퍼스에서 계산하는 방법, 사람 글 0건 문턱과 필요한 표본 수, output style 플러그인과 교정 도구의 비교 지표를 결과보다 먼저 적었습니다. 후보 패턴은 심사를 거친 연구와 국립국어원 간행물이 사람 글과 비교해 보고한 특징에서만 만들었고(43가지), 그런 연구가 없는 줄표·복수형 `-들`·부정 대구 등은 이유와 함께 뺐습니다. 외부 출처는 원문을 열어 인용과 번역을 붙였고, 표본과 결과를 모델 학습에 쓰지 않는다고 명시했습니다
